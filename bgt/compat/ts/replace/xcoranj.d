...
ADD_STATE_TRIGGER ~coranj~ 0 ~Global("ENDOFBG1","GLOBAL",2)~


APPEND ~coranj~

IF WEIGHT #-5 ~Dead("X#CoranWyvern")
...
IF WEIGHT #-4 ~!Dead("X#CoranWyvern")
GlobalLT("ENDOFBG1","GLOBAL",2)
...
IF WEIGHT #-3 ~!Dead("X#CoranWyvern")
GlobalLT("ENDOFBG1","GLOBAL",2)
GlobalTimerExpired("Coran","GLOBAL")
...
IF WEIGHT #-1 ~False()~ THEN BEGIN s7
  SAY @11839
