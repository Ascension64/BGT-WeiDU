/*Imoen to Imoen2 patches - Throne of Bhaal handled by Ascension 1.4.21
...
//Imoen to Imoen2 patches - Other
REPLACE_TRIGGER_TEXT ~unused~ ~"Imoen"~ ~"Imoen2"~

//Imoen to Imoen2 patches - Already Imoen2 in vanilla patched BG2:ToB, patch in case Baldurdash does something
REPLACE_TRIGGER_TEXT ~bhaerd25~ ~"Imoen"~ ~"Imoen2"~
REPLACE_TRIGGER_TEXT ~edwinj~ ~"Imoen"~ ~"Imoen2"~
REPLACE_TRIGGER_TEXT ~gorcamb~ ~"Imoen"~ ~"Imoen2"~
REPLACE_TRIGGER_TEXT ~minscj~ ~"Imoen"~ ~"Imoen2"~
REPLACE_TRIGGER_TEXT ~naliaj~ ~"Imoen"~ ~"Imoen2"~
REPLACE_TRIGGER_TEXT ~viconij~ ~"Imoen"~ ~"Imoen2"~
